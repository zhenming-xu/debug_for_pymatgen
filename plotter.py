...
class DosPlotter:
    ...
    def save_plot(self, filename, img_format="png", dpi=600, xlim=None, ylim=None):
        """
        Save matplotlib plot to a file.

        Args:
            filename: Filename to write to.
            img_format: Image format to use. Defaults to png.
            xlim: Specifies the x-axis limits. Set to None for automatic
                determination.
            ylim: Specifies the y-axis limits.
        """
        plt = self.get_plot(xlim, ylim)
        plt.savefig(filename, format=img_format, dpi=dpi)
...
class BSPlotter:
    ...
    def save_plot(self, filename, img_format="png", ylim=None, dpi=600, 
...
class CohpPlotter:
    ...
    def get_plot(self, xlim=None, ylim=None, plot_negative=None,
                 integrated=False, invert_axes=False):
        """
                ...
                if spin in populations:
                    ...
                    if spin == Spin.up:
                        plt.plot(x, y, color='red',
                                 linestyle='-', label=str(key), linewidth=2)
                    else:
        ...
        if invert_axes:
            plt.xlabel(cohp_label,fontsize=22)
            plt.ylabel(energy_label,fontsize=22)
        else:
            plt.xlabel(energy_label,fontsize=22)
            plt.ylabel(cohp_label,fontsize=22)
    ...
    def save_icohp_plot(self, filename, img_format="png", xlim=None, ylim=None):
        """
        Save matplotlib plot to a file.
        ...
        Args:
            ...
            ylim: Specifies the y-axis limits. Defaults to None for
                automatic determination.
        """
        plt = self.get_plot(xlim, ylim, plot_negative=True, integrated=True, invert_axes=False)
        plt.savefig(filename, format=img_format, dpi=600)

    def save_plot(self, filename, img_format="png", xlim=None, ylim=None):
        """
        Save matplotlib plot to a file.
